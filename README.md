...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-b6au3b0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-b6au3b0.containers.anotherwebservice.com/
...
```
git clone git@github.com:ryushinmd/container-b6au3b0.git
cd container-b6au3b0
```
...
```
docker attach container-b6au3b0
```
